// Enrollment — the "Outstanding enrollment tokens" panel and the
// associated "Add agent" dialog. Extracted from the original
// pages/Agents.tsx so the new Overview dropdown can route to it as
// one option among many.
//
// The dialog is rendered inline (controlled by local state); it
// could move into a modal portal later but the existing UX matches
// the rest of the app.

import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { useEffect, useState } from "react";
import { ApiError, api } from "../../api/client";
import type { EnrollmentToken, NewEnrollmentToken, Site } from "../../api/types";
